...
export class AdminsController implements interfaces.Controller{
    ...
    @httpPost('/user/:firstname&:lastname&:email&:username&:password')
    ...
    @httpGet('/user/info/:username&:password')
    ...
    @httpPost('/user/info/:username&:password&:firstname&:lastname&:email&:newPassword')
